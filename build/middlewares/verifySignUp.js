...
var checkExistingUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var sql, pool, promiseQuery, promisePoolEnd, result, userFound, sql2, pool2, promiseQuery2, promisePoolEnd2, result2, userFound2, sql3, pool3, promiseQuery3, promisePoolEnd3, result3, userFound3;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          sql = "CALL sp_obtener_usuario_username('".concat(req.body.username, "')");
        ...
        case 13:
          // Para el correo:
          sql2 = "CALL sp_obtener_usuario_correo('".concat(req.body.email, "')");
        ...
        case 19:
          ...
          promisePoolEnd2();
          userFound2 = Object.values(JSON.parse(JSON.stringify(result2[0])));
        ...
        case 25:
          // Para el dni:
          sql3 = "CALL sp_obtener_usuario_dni('".concat(req.body.dni, "')");
        ...
        case 31:
          ...
          promisePoolEnd3();
          userFound3 = Object.values(JSON.parse(JSON.stringify(result3[0])));
